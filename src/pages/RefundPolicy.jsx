  ...
  return (
    <div className="min-h-screen pt-28" style={{ backgroundColor: '#F9FAFC' }}>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-8 border-2 border-gray-200 shadow-lg">
        ...
        {/* Nature of Services */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>2. Nature of Our Services</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* No Refund Policy */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>3. No Refund Policy</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>Once a service is purchased or activated:</p>
        ...
        {/* Exceptions */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>4. Exceptions</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
            Notwithstanding the above, refunds may be issued only under the following limited
            circumstances:
          </p>
          
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>A. Duplicate Payment</p>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>B. Incorrect or Failed Transaction</p>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>C. Unauthorized Payment</p>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>Note:</p>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>5. Refund Request Procedure</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>To request a refund under the above exceptions, users must:</p>
          ...
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>Refund requests will be reviewed by our support and finance teams.</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>6. Refund Mode and Timeline</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>Processing timelines may vary based on the payment method:</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>7. Non-Eligible Transactions</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>Refunds will not be provided for the following situations:</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>8. Cancellation of Subscription</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Governing Law */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>9. Governing Law and Jurisdiction</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Contact Information */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>10. Contact Information</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Grievance Officer */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>11. Grievance Officer</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
